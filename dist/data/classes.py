...
class Material(pygame.sprite.Sprite):
    def __init__(self,co,producer_info):
        super().__init__()
        self.image_copper=pygame.image.load('data/images/copper.png').convert_alpha()
        self.image_iron=pygame.image.load('data/images/iron.png').convert_alpha()
        self.image_gold=pygame.image.load('data/images/gold.png').convert_alpha()
        self.image_aluminium=pygame.image.load('data/images/aluminium.png').convert_alpha()
        self.image_coal=pygame.image.load('data/images/coal.png').convert_alpha()
        self.image_lead=pygame.image.load('data/images/lead.png').convert_alpha()
        self.spawn_co=co
        ...
        self.rect=self.image.get_rect(midtop=(self.spawn_co[0]+20,self.spawn_co[1]+20))
        self.count=0
...
class Items(pygame.sprite.Sprite):
    ...
    def update(self,seller_lv,seller_upgrades,conveyor_lv,conveyor_upgrades,crafter_info,conveyor_group,conveyor_info,crafter_group,seller_group,money):
        ...
        if self.count<8 and self.crafter_thrust:
...
class Blueprints(pygame.sprite.Sprite):
    def  __init__(self,title_position,y,blueprints_value,empty_slot_img,bp_ordered_list,blueprints,item_imgs,font_24,font_20,font):
        ...
        self.image=pygame.image.load('data/images/gui_flat.png').convert_alpha()
...
class Arrow(pygame.sprite.Sprite):
    def __init__(self,x,y,producer_info,crafter_info,conveyor_info,seller_info):
        super().__init__()
        self.image=pygame.image.load('data/images/arrow.png').convert_alpha()
        self.image=pygame.transform.scale(self.image, (40, 40))
...
class GreenSquare(pygame.sprite.Sprite):
    def __init__(self,x,y):
        super().__init__()
        self.image=pygame.image.load('data/images/green_square.png').convert_alpha()
        self.image=pygame.transform.scale(self.image, (40, 40))
        self.rect=self.image.get_rect(topleft=(x,y))
