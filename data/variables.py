...
font = pygame.font.Font('data/pixeltype.ttf',16)
font_20 = pygame.font.Font('data/pixeltype.ttf',20)
font_24 = pygame.font.Font('data/pixeltype.ttf',24)
font_32 = pygame.font.Font('data/pixeltype.ttf',32)
font_34 = pygame.font.Font('data/pixeltype.ttf',34)
font_36 = pygame.font.Font('data/pixeltype.ttf',36)
font_38 = pygame.font.Font('data/pixeltype.ttf',38)
font_40 = pygame.font.Font('data/pixeltype.ttf',40)
font_42 = pygame.font.Font('data/pixeltype.ttf',38)
font_50 = pygame.font.Font('data/pixeltype.ttf',50)
font_60 = pygame.font.Font('data/pixeltype.ttf',60)
font_70 = pygame.font.Font('data/pixeltype.ttf',70)
font_80 = pygame.font.Font('data/pixeltype.ttf',80)
font_90 = pygame.font.Font('data/pixeltype.ttf',90)
font_100 = pygame.font.Font('data/pixeltype.ttf',100)
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#audio stuff
bg1=pygame.mixer.Sound("data/audio/bg1.mp3")
bg2=pygame.mixer.Sound("data/audio/bg2.mp3")
bg3=pygame.mixer.Sound("data/audio/bg3.mp3")

intro=pygame.mixer.Sound("data/audio/intro.mp3")
malfunction=pygame.mixer.Sound("data/audio/malfunction.wav")
activation=pygame.mixer.Sound("data/audio/activation.wav")
hum=pygame.mixer.Sound("data/audio/hum.wav")

click1=pygame.mixer.Sound("data/audio/click1.wav")
click2=pygame.mixer.Sound("data/audio/click2.wav")
...
#blueprints stuff
#material images
copper_img=pygame.image.load('data/images/copper.png').convert_alpha()
iron_img=pygame.image.load('data/images/iron.png').convert_alpha()
gold_img=pygame.image.load('data/images/gold.png').convert_alpha()
aluminium_img=pygame.image.load('data/images/aluminium.png').convert_alpha()
coal_img=pygame.image.load('data/images/coal.png').convert_alpha()
lead_img=pygame.image.load('data/images/lead.png').convert_alpha()
empty_slot_img=pygame.image.load('data/images/cross.png').convert_alpha()
#item images
circuit_img=pygame.image.load('data/images/circuit.png').convert_alpha()
ram_img=pygame.image.load('data/images/ram.png').convert_alpha()
cpu_img=pygame.image.load('data/images/cpu.png').convert_alpha()
gpu_img=pygame.image.load('data/images/gpu.png').convert_alpha()
hdd_img=pygame.image.load('data/images/hdd.png').convert_alpha()
computer_img=pygame.image.load('data/images/pc.png').convert_alpha()
power_supply_img=pygame.image.load('data/images/power supply.png').convert_alpha()
motherboard_img=pygame.image.load('data/images/motherboard.png').convert_alpha()


battery_img=pygame.image.load('data/images/battery.png').convert_alpha()
engine_img=pygame.image.load('data/images/engine.png').convert_alpha()

super_computer_img=pygame.image.load('data/images/super computer.png').convert_alpha()
cabin_img=pygame.image.load('data/images/cabin.png').convert_alpha()
jet_thruster_img=pygame.image.load('data/images/jet thruster.png').convert_alpha()
mega_engine_img=pygame.image.load('data/images/mega engine.png').convert_alpha()
compressed_coal_img=pygame.image.load('data/images/cross.png').convert_alpha()
fuel_tank_img=pygame.image.load('data/images/cross.png').convert_alpha()
rocket_img=pygame.image.load('data/images/rocket.png').convert_alpha()
...
play_img = pygame.image.load('data/images/Play.png').convert_alpha()
controls_img = pygame.image.load('data/images/Controls.png').convert_alpha()
settings_img = pygame.image.load('data/images/Settings.png').convert_alpha()
exit_img = pygame.image.load('data/images/Exit.png').convert_alpha()
back_img = pygame.image.load('data/images/back.png').convert_alpha()
...
#play mode
#play button images:
settings_mini_img=pygame.image.load('data/images/settings_mini.png').convert_alpha()
blank_button_img=pygame.image.load('data/images/button4.png').convert_alpha()
shop_img=pygame.image.load('data/images/shop.png').convert_alpha()
edit_img=pygame.image.load('data/images/edit.png').convert_alpha()
blueprints_img=pygame.image.load('data/images/blueprints.png').convert_alpha()
map_img=pygame.image.load('data/images/button4.png').convert_alpha()
gui_flat_img=pygame.image.load('data/images/gui_flat.png').convert_alpha()
play_bg_img=pygame.image.load('data/images/play_bg2.png').convert_alpha()
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#settings
settings_img=pygame.image.load('data/images/settings_panel.png').convert_alpha()
...
resume_img=pygame.image.load('data/images/resume.png').convert_alpha()
menu_img=pygame.image.load('data/images/menu.png').convert_alpha()
...
#machine stuff
#sprite images:
producer_img=pygame.image.load('data/images/producer.png').convert_alpha()
crafter_img=pygame.image.load('data/images/crafter.png').convert_alpha()
conveyor_img=pygame.image.load('data/images/conveyor.png').convert_alpha()
seller_img=pygame.image.load('data/images/seller.png').convert_alpha()
...
producer_popup_img=pygame.image.load('data/images/gui_flat.png').convert_alpha()
...
#background images
main_menu_bg=pygame.image.load('data/images/background.png').convert_alpha()
main_menu_bg=pygame.transform.scale(main_menu_bg,(900,900))
grid_img = pygame.image.load('data/images/grid.png').convert_alpha()
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#miscellaneous
blank_popup_img=pygame.image.load('data/images/panel8.png').convert_alpha()
...
#scrollbar images
scrollbar_img=pygame.image.load('data/images/scrollbar.png').convert_alpha()
scrollbar_img=pygame.transform.rotate(scrollbar_img,270)
slider_img=pygame.image.load('data/images/slider.png').convert_alpha()
...
blueprint_tab_img=pygame.image.load('data/images/gui_flat.png').convert_alpha()
blueprint_tab_surface=pygame.transform.scale(blueprint_tab_img,(200,225))

#money panel
money_panel_img=pygame.image.load('data/images/panel3.png').convert_alpha()
#money_panel_surface=pygame.transform.scale(money_panel_img,(400,70))

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#edit stuff
#edit button images:
rotate_img =pygame.image.load('data/images/rotate.png').convert_alpha()
delete_img =pygame.image.load('data/images/delete.png').convert_alpha()
...
#shop button images:
mini_exit_img=pygame.image.load('data/images/mini_exit.png').convert_alpha()
gui_flat_img=pygame.image.load('data/images/gui_flat.png').convert_alpha()
...
confirm_img=pygame.image.load('data/images/confirm.png').convert_alpha()
cancel_img=pygame.image.load('data/images/cancel.png').convert_alpha()
green_square_img=pygame.image.load('data/images/green_square.png').convert_alpha()
