...
class Material(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if pygame.sprite.spritecollideany(self,conveyor_group):
            ...
            print(self.conveyor_direction)
            self.conveyor_thrust=True
            

        if self.count<7 and self.producer_thrust==True:
            print(self.count)
        ...
        if self.count<7 and self.conveyor_thrust==True:
...
class Conveyor(pygame.sprite.Sprite):
    def __init__(self,x,y):
        ...
        self.image=pygame.transform.scale(self.image, (40, 40))
        self.image_N=pygame.transform.rotate(self.image,270)
        self.image_E=self.image
        self.image_S=pygame.transform.rotate(self.image,90)
        self.image_W=pygame.transform.rotate(self.image,180)
